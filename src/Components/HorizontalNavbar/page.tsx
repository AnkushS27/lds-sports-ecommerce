      ...
      <div className={style1.NavMainContainer}>
        ...
        <div className={style1.NavLogoSection}>
          ...
          {params.loggedIn ? (
            ...
            <div className={style1.iconsContainer}>
              <Link href="/login" className={style1.navAuthenticationItem}>
                {" "}
                <span>Login</span>{" "}
              </Link>
              <Link href="/signup" className={style1.navAuthenticationItem}>
                {" "}
                <span>Signup</span>{" "}
              </Link>
            </div>
        ...
        <div className={style1.NavRightSection}>
          ...
          <div className={style1.navSearchbarContainer}>
            <input
              type="text"
              className={style1.NavSearchBox}
              onChange={(e) => {
                setSearch(e.target.value);
              }}
              placeholder="Search here"
            />
            <Link href={`/search/${search}`} className={style1.navSearchBtn}>
              Search
            </Link>
          </div>
          ...
          {params.loggedIn ? (
            <div className={style1.navAuthenticationCotanier}>
              <Link href="/myaccount" className={style1.navAuthenticationItem}>
                <span>Profile</span>
              </Link>
              <div
                className={style1.navAuthenticationItem}
                onClick={() => {
                  signOut({ callbackUrl: "/" });
                }}
              >
