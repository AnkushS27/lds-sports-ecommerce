  ...
  return (
    <div className={style1.mainWrapper}>
      ...
      <div className={style1.mainContainer}>
        ...
        <div className={style1.rightSection}>
          <div className={style1.linkHolder}>
            ...
            <Link href="/" className={style1.linkItem}>
              Home
            </Link>
            <Link href="/myaccount" className={style1.linkItem}>
              Account
            </Link>
            <Link href="/cart" className={style1.linkItem}>
              Cart
            </Link>
          </div>
          <div className={style1.linkHolder}>
            <div className={style1.linkHolderHead}> Support </div>
            <Link href="/faq" className={style1.linkItem}>
              FAQ
            </Link>
            <Link href="#" className={style1.linkItem}>
              abc@gmail.com
      ...
      <div className={style1.copyRightSection}>
        @copyright belongs to the lds-sports
      </div>
    </div>
  );
}
